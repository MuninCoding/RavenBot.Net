        ...
        public async Task BattleStats(SocketGuildUser user = null)
        {
            ...
            if (user != null)
            {
                ...
                embed1.WithColor(Color.DarkRed)
                     ...
                     .AddField("Current Player Killed", account.BattleStatistics.CurrentPlayerKillStreak.ToString(), true)
                     .AddField("Current Creep Winstreak", account.BattleStatistics.CurrentCreepWinStreak.ToString(), true)
                     .AddField("Current Enemies killed", account.BattleStatistics.CurrentEnemiesKilled.ToString(), true)
                     .AddField("Highest PvP Winstreak", account.BattleStatistics.HighestPvPWinStreak.ToString(), true)
                     .AddField("Highest Player Killstreak", account.BattleStatistics.HighestPlayerKillStreak.ToString(), true)
